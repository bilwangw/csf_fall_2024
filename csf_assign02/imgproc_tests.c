...
void test_blend_rgb() {
  ...
  //printf("%u\n", make_pixel(blend_rgb(0xFF, 0x15, 0xFF), blend_rgb(0x21, 0xCD, 0xFF), blend_rgb(0x10, 0x10, 0xFF), 0xFF));
  //ASSERT(0x528E3D23 == make_pixel(blend_rgb(0x21, 0x5A, 0x23), blend_rgb(0xBC, 0x87, 0x23), blend_rgb(0xFF, 0x1F, 0x23), 0x23));
  printf("\n%x\n", blend_rgb(0xFF, 0x15, 0xFF));
  printf("%x\n", blend_rgb(0x21, 0xCD, 0xFF));
  printf("%x\n", blend_rgb(0x10, 0x10, 0xFF));
  // pixels to blend: 0xFF2110FF, 0x15CD10FF
  ASSERT(0xFF == blend_rgb(0xFF, 0x15, 0xFF));
  ASSERT(0x21 == blend_rgb(0x21, 0xCD, 0xFF));
  ASSERT(0x10 == blend_rgb(0x10, 0x10, 0xFF));
  uint32_t r = blend_rgb(0xFF, 0x15, 0xFF);
  uint32_t g = blend_rgb(0x21, 0xCD, 0xFF);
  uint32_t b = blend_rgb(0x10, 0x10, 0xFF);
  ASSERT(0xFF2110FF == make_pixel(r, g, b, 0xFF));
  //ASSERT(0xFF2110FF == make_pixel(blend_rgb(0xFF, 0x15, 0xFF), blend_rgb(0x21, 0xCD, 0xFF), blend_rgb(0x10, 0x10, 0xFF), 0xFF));
  // pixels to blend: 0xCD210955, 0x15CD92FF
  r = blend_rgb(0xCD, 0x15, 0x55);
  g = blend_rgb(0x21, 0xCD, 0x55);
  b = blend_rgb(0x09, 0x92, 0x55);
  printf("\n%x\n", r);
  printf("%x\n", g);
  printf("%x\n", b);
...
void test_make_pixel() {
  ...
  pixel = make_pixel(0xFF, 0x21, 0x10, 0xFF);
  ASSERT(pixel == 0xFF2110FF);

  ASSERT(pixel = make_pixel(get_r(pixel), get_g(pixel), get_b(pixel), get_a(pixel)));
}
